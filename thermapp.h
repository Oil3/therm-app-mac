...
#pragma pack(push, 1)
// AD5628 DAC in ThermApp is for generating control voltage
...
struct cfg_packet {
    ...
    unsigned short VoutA;            // DCoffset; AD5628 VoutA
    unsigned short none_volatile_data7;
    unsigned short VoutC;            // gain; AD5628 VoutC
    unsigned short VoutD;            // AD5628 VoutD
    unsigned short VoutE;            // AD5628 VoutE
